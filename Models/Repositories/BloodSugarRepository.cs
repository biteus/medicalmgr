...
{
    public class BloodSugarRepository : IBloodSugar
    {
        private readonly MedicalManagerDBContext _dbContext;
        private readonly ILogger<BloodSugarRepository> _logger;


        public BloodSugarRepository(MedicalManagerDBContext dbContext, ILogger<BloodSugarRepository> logger)
        {
        ...
        public BloodSugar AddBloodSugar(BloodSugar bs, string UserId)
        {
            bs.UerID = UserId;
            _dbContext.BloodSugars.Add(bs);
            _dbContext.SaveChanges();
            return bs;
        }

        public BloodSugar DeleteBloodSugar(int id, string UserId)
        {
            throw new NotImplementedException();
        }

        public BloodSugar EditBloodSugar(BloodSugar bs, string UserId)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<BloodSugar> GetAllBloodSugar(string UserId)
        {
            return _dbContext.BloodSugars.Where(m => m.UerID.Contains(UserId));
        }

        public BloodSugar GetBloodSugar(int Id, string UserId)
        {
            throw new NotImplementedException();
        }

        public BloodSugar UpdateBloodSugar(BloodSugar bs, string UserId)
        {
            throw new NotImplementedException();
        }
